/**
 * Script to add two sample blog posts for the Voynich Manuscript Analysis Platform
 * 
...
const blogPosts = [
  {
    ...
    featuredImage: "/uploads/pages-1741734334214-330569398.png",
...
<p>As AI continues to evolve, it may ultimately provide the breakthrough that has eluded scholars for generations, revealing whether the manuscript contains an unknown natural language, an early constructed language, or an elaborate encryption system designed to protect esoteric knowledge.</p>`,
  ...
  },
  {
    ...
    featuredImage: "/uploads/pages-1741734334182-401698183.png",
...
<p>As technology continues to advance and collaboration becomes more sophisticated, we move closer to understanding this enigmatic document that has fascinated scholars for generations.</p>`,
    ...
    status: "published",
    metaTitle: "Community Collaboration in Voynich Manuscript Research | Collaborative Analysis",
...
// Run the script
// In ES modules, you can check if this is the main module by comparing import.meta.url
// against process.argv[1], but for simplicity we'll just run it
addSamplePosts().then(() => process.exit(0));

export { addSamplePosts };